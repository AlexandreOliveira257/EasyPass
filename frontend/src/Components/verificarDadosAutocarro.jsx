...
function VerificarDadosAutocarro({setView}){
    ...
    return(
        ...
        {activeTab === 0 && (
          <div className="form">
            ...
            <button onClick={()=>setView("escolherPasseAutocarro")} className="save-btn">{t('guardar').toUpperCase()}</button>
          </div>
        )}
...
} export default VerificarDadosAutocarro