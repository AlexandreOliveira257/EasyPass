...
const [passeFisico, setPasseFisico] = useState(false);
  ...
  const notifyInfo = () => toast.info('Para mais informações consulte as suas notificações!', {
          ...
          const response = await fetch(url, {
            ...
            body: JSON.stringify({
              ...
              saldo: 0,
               ...
               mensagemPedido:   "Pedido de Passe Físico da modalidade Passe Verde."  
            })
          });
    ...
    return(
        ...
        <span></span><img onClick={()=>setView("escolherPasseComboio")} className="goBackBtn" src="icons/goBackBtn.svg"/>
        </div>
